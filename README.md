...
- Авторизация запросов по секретному ключу (`X-Secret-Key`)
- [Тестирование](#-тестирование) с помощью pytest используя Docker Compose
...
- **`.env.docker.test.example`** — пример конфигурационного файла для запуска тестов через Docker
